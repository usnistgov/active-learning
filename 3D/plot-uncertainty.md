...
```python
def plot_diversity(scores, opt=None, error_freq=20, ylog=False, scale=1.0, fontsize=20):
...
```python
plot_diversity(data_agg, ylog=False, error_freq=100, scale=scale, fontsize=22)
plt.title('(d)')
